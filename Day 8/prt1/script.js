...
function loadButtonEvents(){
    ...
    submitAgenciesButtonstart + ',' + destinationstart + ',' + destination.addEventListener('click', function (event) {
      event.preventDefault()
...
function getJourney(){
    ...
    request.open('GET', 'https://platform.whereismytransport.com/api/journeys' , true);
    request.setRequestHeader('Accept', 'application/json');
